...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val parentView = inflater.inflate(R.layout.fragment_first, container, false)

        val btnNext : Button = parentView.findViewById(R.id.btnNext);

        //onButtonClick change fragment to SecondFragment!
        btnNext.setOnClickListener {
            ...
            mMediatorCallback?.changeFragmentTo(SecondFragment(), SecondFragment:: class.simpleName)
        }
